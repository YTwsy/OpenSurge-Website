...
const copy = {
  en: {
    ...
    learnCards: [
      ...
      ["Guide", "Take over LAN DHCP safely", "Prepare the offline recovery path before automatic onboarding.", "/guides/dhcp-takeover-recovery/"],
      ["Docs", "Route traffic from the Mac", "Separate local Rule, Global, and Direct from system-proxy coordination.", "/docs/local-mac-routing-system-proxy/"],
      ["Docs", "Import a mihomo configuration", "Keep nodes and rules while OpenSurge owns gateway-critical fields.", "/docs/imported-mihomo-config/"],
  ...
  "zh-CN": {
    ...
    learnCards: [
      ...
      ["指南", "安全接管局域网 DHCP", "在自动接入前准备离线恢复与停止路径。", "/zh-cn/guides/dhcp-takeover-recovery/"],
      ["文档", "控制 Mac 本机出口", "区分规则、全局、直连与系统代理协同。", "/zh-cn/docs/local-mac-routing-system-proxy/"],
      ["文档", "导入 mihomo 配置", "保留节点与规则，同时由 OpenSurge 管理网关关键字段。", "/zh-cn/docs/imported-mihomo-config/"],
